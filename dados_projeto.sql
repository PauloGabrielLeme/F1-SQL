...
VALUES
   (1, 'Charles', 'Leclerc', 'charles.leclerc@gmail.com', 37200, 'Rua das Garagens', 'Mônaco-Ville', 'Mônaco', '41015', 16, 10, 1997, 1),
   ...
   (13, 'Tamaka', 'Shinoda', 'lukas.schneider@gmail.com', 4600, 'Benzstraße', 'Toquio', 'Japão', '70175', 19, 2, 1990, 4),
   ...
   (20, 'Zin', 'XAO', 'pierre.gasly@gmail.com', 9500, 'Pit Street', 'Pequim', 'China', '50247', 7, 2, 1996, 2);

INSERT INTO projeto_f1.patrocinadores (id_patrocinador, nome_patrocinador) 
VALUES
   (1, 'AMD'),
   (2, 'Petronas'),
   (3, 'Oracle'),
...
INSERT INTO projeto_f1.equipes_patrocinadores (equipe_id, patrocinador_id, valor_patrocinio, duracao_mes_patrocinio, tipo_patrocinio) 
VALUES
...
INSERT INTO projeto_f1.telefones (telefone_funcionario, funcionario_id) 
VALUES
   ('11985743321', 1),
   ('11977665544', 2),
   ('11999887766', 3),
...
INSERT INTO projeto_f1.corridas (id_corrida, localizacao_cidade_corrida, temporada_corrida) 
VALUES
   (1, 'Singapura', '2025'),
   (2, 'Spielberg', '2020'),
   (3, 'Interlagos', '2023'),
...
INSERT INTO projeto_f1.fabricantes (id_fabricante, nome_fabricante, custo_temporada_fabricante) 
VALUES
...
INSERT INTO projeto_f1.equipes_associadas (equipe_id, fabricante_id) 
VALUES
   (1, 1),
   (2, 3),
   (3, 2),
...
INSERT INTO projeto_f1.pecas (id_peca, nome_peca, fabricante_id)
 VALUES
...
INSERT INTO projeto_f1.chefes_equipes (funcionario_id, formacao_chefe, experiencia_anos_chefe) 
VALUES
...
INSERT INTO projeto_f1.pilotos (funcionario_id, tipo_piloto, historico_pontos_piloto) 
VALUES
   (1, 'Titular', 72),
   (2, 'Titular', 79),
   (3, 'Titular', 42),
...
INSERT INTO projeto_f1.carros (id_carro, cor_carro, chassi_carro, ano_carro, funcionario_id) 
VALUES
   (1, 'Vermelho', 'CHSFER1929', 2024, 1),
   (2, 'Verde', 'CHSAST1913', 2023, 2),
   (3, 'Prata', 'CHSMER1926', 2024, 3),
   (4, 'Azul', 'CHSRED2005', 2025, 16),
   (5, 'Laranja', 'CHSMCL1963', 2023, 5);

INSERT INTO projeto_f1.departamentos_medicos (funcionario_id, especialidade_medico) 
VALUES
   (6, 'Ortopedia'),
   (7, 'Fisioterapia'),
...
INSERT INTO projeto_f1.certificacoes (certificacao, funcionario_id) 
VALUES
   ('ATLS', 6),
   ('SBOT', 6),
...
INSERT INTO projeto_f1.mecanicos (funcionario_id, id_crea_mecanico, nivel_experiencia_mecanico) 
VALUES
   (12, '12345', 'Sênior'),
   (13, '12346', 'Pleno'),
   (14, '12347', 'Júnior'),
...
INSERT INTO projeto_f1.mecanicos_pecas (peca_id, funcionario_id) 
VALUES
   (1, 12),
   (2, 13),
   (3, 14),
...
INSERT INTO projeto_f1.mecanicos_carros (funcionario_id, carro_id) 
VALUES
   (12, 1),
   (13, 2),
   (14, 3),
...
INSERT INTO projeto_f1.corridas_pilotos (corrida_id, funcionario_id, pontuacao_piloto) 
VALUES
   (1, 1, 25),
   (1, 2, 18),
   (1, 5, 12),
...
INSERT INTO projeto_f1.corridas_equipes (corrida_id, equipe_id, posicao_equipe) 
VALUES
   (1, 1, 1),
   (1, 2, 2),
   (1, 3, 3),
